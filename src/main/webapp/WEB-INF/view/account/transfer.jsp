...
<div class="col-sm-8">
	...
	<form action="/account/transfer" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" placeholder="Enter w account number" id="wAccountNumber" name="wAccountNumber" value="1111">
		</div>
		<div class="form-group">
			<label for="password">출금 계좌 비밀번호:</label> 
			<input type="password" class="form-control" placeholder="Enter account password" id="password" name="password" value="1234">
		</div>
		<div class="form-group">
